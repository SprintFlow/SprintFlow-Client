...
export default function CreateSprint() {
  ...
  // Manejar cambio de puntos con botones +/-
  ...
  const handleSaveSprint = async () => {
    ...
    try {
      ...
      setError(`❌ Error: ${err.message || "Error al crear el sprint"}`);
      setSnackbarOpen(true);
    } finally {
      setLoading(false);
    }
        ...
        <Box sx={{ width: "100%" }}>
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} lg={8}>
              ...
              {/* Historias Planificadas - TABLA FIJA SIN SCROLL */}
              <Card
                elevation={0}
                sx={{
                  background: styles.cardBg,
            ...
            <Grid item xs={12} lg={4}>
              ...
              >
                <CardContent sx={{ p: 3 }}>
                  ...
                  {/* Alerta específica para equipo si hay error */}
